...
class GameRules ():
    def __init__(self, num_rows: int, num_columns: int, num_obstacles: int, num_balls: int, size: int, speed: float, json_filename: str, export_filename: str,
        ...
        def setup_game():
            ...
            setup_controller.setup_model(
                obstacle_setup, ball_setup, item_type, json_filename, export_filename)
